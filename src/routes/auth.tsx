  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-16">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        For pastors, admins, and peer mentors only. Public submissions remain anonymous and require no account.
      </p>
        ...
        {mode === "signup" && (
          <label className="block">
            ...
            <input
              ...
              value={displayName} onChange={(e) => setDisplayName(e.target.value)} maxLength={120}
            />
          </label>
        )}
        <label className="block">
      ...
      <Link to="/" className="mt-8 text-center text-xs uppercase tracking-[0.3em] text-muted-foreground hover:text-ivory">
