...
import heroImage from "@/assets/throne_hero.png";
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "A confidential digital sanctuary where you can confess your lust and perversion, request a partner, seek filthy pastoral counsel, share lustful testimony, and walk in pleasure.",
      },
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-3xl">
        ...
        <h1 className="mt-8 font-serif text-5xl leading-[1.02] text-ivory sm:text-7xl md:text-[5.5rem]">
          Approach the
          <span className="block italic gold-text">Throne of Sinners.</span>
        </h1>
...
const CHAMBERS: Chamber[] = [
  ...
  {
    icon: MessagesSquare,
    title: "The Counsel of sinners",
    verse: "  ",
    body: "Request marriage, relationship, grief, addiction or spiritual counseling. A pastor will be assigned and a meeting scheduled.",
    to: "/counsel",
  },
  {
    icon: BookOpenText,
    title: "The Testimony",
    verse: "  ",
    body: "Share the story of your escapades. Every testimony is reviewed by pastoral leadership before it is offered as a light to others.",
    to: "/testimony",
  },
  {
    icon: UsersRound,
  ...
  },
  {
    ...
    title: "Lust Partners",
    verse: "  ",
    body: "Anonymous one-to-one perv matching. Pastor-supervised, confidential, and built on mutual covenant.",
    to: "/partners",
  },
];
